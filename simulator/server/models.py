"""SQLAlchemy 模型,与 ecommerce-vue-ts/backend/models.py 完全镜像。
...
class Order(Base):
    ...
    __table_args__ = (Index("idx_customer_status_created", "customer_id", "status", "created_at"),)
    id = Column(Integer, primary_key=True, index=True)
...
class FinanceRecord(Base):
    ...
    __table_args__ = (Index("idx_type_category_recorded", "type", "category", "recorded_at"),)
    id = Column(Integer, primary_key=True, index=True)
